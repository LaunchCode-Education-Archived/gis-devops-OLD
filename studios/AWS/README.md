...
![Screen shot demonstrating an empty Add Tags screen and the Add Tag button](/../../materials/week05/add-tags-screen.png)
...
Now, on the server, move the file to the airwaze home directory, and make it owned and executable by that user.
```nohighlight
