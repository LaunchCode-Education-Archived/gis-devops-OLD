...
Create the index and upload the document mapping in your new AWS ES domain. You can follow the instructions from the walkthrough, changing `localhost:9200` with your new AWS ES endpoint and changing out `airwaze` for the name of your new domain (such as `airwaze-me`).
